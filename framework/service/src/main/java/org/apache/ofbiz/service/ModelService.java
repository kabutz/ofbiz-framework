...
public class ModelService extends AbstractMap<String, Object> implements Serializable {
    ...
    private record ModelServiceMapEntry(ModelService outer, Field field) implements Map.Entry<String, Object> {
        ...
        public boolean equals(Object o) {
            ...
            return o instanceof ModelServiceMapEntry(var otherModelService, var otherField)
                    && field.equals(otherField) && outer == otherModelService;
        }
            ...
            public Iterator<Map.Entry<String, Object>> iterator() {
                return new Iterator<Map.Entry<String, Object>>() {
                    ...
                    public Map.Entry<String, Object> next() {
                        ...
                        return new ModelServiceMapEntry(ModelService.this, MODEL_SERVICE_FIELDS[i++]);
                    }
    ...
    private static Gatherer<ModelParam, ?, String> htmlValidationGatherer(
        ...
        return Gatherer.of(() -> new ArrayList<String>(), (acc, param, _) -> {
